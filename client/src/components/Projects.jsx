...
const initialProjects = [
  {
    ...
    description:
      "A high-performance real-time analytics dashboard for monitoring server metrics across distributed systems.",
  },
  {
    id: 2,
    ...
    category: "E-Commerce",
    image:
      "https://images.unsplash.com/photo-1614728263952-84ea256f9679?q=80&w=2808&auto=format&fit=crop",
    tech: ["Next.js", "Stripe", "PostgreSQL"],
    description:
      "A fully headless e-commerce solution with 3D product previews and AI-powered recommendations.",
  },
  {
    id: 3,
    title: "Cyber Chat",
    ...
    description:
      "End-to-end encrypted messaging platform with self-destructing messages and cyberpunk UI themes.",
  },
  {
    id: 4,
    title: "AI Nexus",
    ...
    description:
      "An interface for generative AI models allowing users to create assets for games and movies.",
  },
];
          ...
          <DialogContent className="bg-black/95 border-primary/20 text-white">
            ...
            <div className="space-y-4 py-4">
              ...
              <Input
                ...
                value={newItem.tech}
                onChange={(e) =>
                  setNewItem({ ...newItem, tech: e.target.value })
                }
                className="bg-white/5 border-white/10"
              />
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {items.map((project, index) => (
          <ProjectCard
            ...
            project={project}
            index={index}
            onRemove={() => removeItem(project.id)}
          />
        ))}
      </div>
    </section>
        ...
        <div className="grid md:grid-cols-2 h-full">
          ...
          <div className="p-8 flex flex-col justify-center space-y-6">
            ...
            <div className="space-y-4">
              <h4 className="font-orbitron text-sm text-gray-400">
                TECHNOLOGIES
              </h4>
              <div className="flex flex-wrap gap-2">
                {project.tech.map((t) => (
                  <span
                    key={t}
                    className="px-3 py-1 border border-primary/30 rounded-full text-sm font-rajdhani text-primary"
                  >
                    {t}
                  </span>
                ))}
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Button
                variant="outline"
                className="flex-1 border-white/20 hover:bg-white/10 font-orbitron neon-blink-hover vibrate-active"
              >
