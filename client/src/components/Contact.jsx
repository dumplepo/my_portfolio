        ...
        <div className="grid md:grid-cols-2 gap-12 relative z-10">
          <div>
            ...
            <p className="text-gray-300 font-space mb-8 leading-relaxed">
              Ready to start your next project? Whether you have a question or
            ...
            <div className="flex gap-4 mt-10">
              {[Github, Linkedin, Twitter].map((Icon, i) => (
                <a
                  key={i}
                  href="https://github.com/dumplepo"
                  target="_blank"
                  rel="noreferrer"
          ...
          <form className="space-y-6 bg-black/20 p-6 rounded-2xl border border-white/5">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-xs font-orbitron text-gray-400">
                  NAME
                </label>
                <Input
                  className="bg-white/5 border-white/10 focus:border-primary text-white font-space h-12"
            ...
            <div className="space-y-2">
              ...
              <Textarea
                className="bg-white/5 border-white/10 focus:border-primary text-white font-space min-h-[150px]"
