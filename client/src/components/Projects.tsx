...
const initialProjects = [
  ...
  },
  {
    ...
    tech: ["Python", "FLASK", "TRANSFORMERS", "PYTORCH"],
    description: "An interactive Flask web app for sentiment and emotion analysis using pretrained Transformer models. It applies a full NLP pipeline (cleaning, tokenization, lemmatization, POS, NER), runs inference with multiple models, generates a word cloud, persists results in SQLite, and provides a downloadable analysis report.",
    livedemo: "https://huggingface.co/spaces/aradhyapavan/nlp-sentiment-analysis-pretarined-models",
    githublink: "https://github.com/dumplepo/NLP_Sentiment_Analysis.git",
  },
  {
    id: 3,
    title: "Enhanced Feedback Analysis System",
    category: "Agentic AI",
    image: "/public/images/agentic.png",
    tech: ["Python", "Flask (REST + SSE)", "Mistral + Phidata (Agentic)", "LangChain (RAG)", "FAISS", "all-MiniLM-L6-v2", "Pandas", "Bootstrap", "Jinja2"],
    description: "A multi-agent NLP platform that extracts rich, structured insights from customer feedback. Beyond basic sentiment analysis, it performs NER, Sentiment Quintuple Extraction, Coreference Resolution, and Comparative Opinion Mining — powered by agentic LLM workflows.",
    livedemo: "https://bits-dissertation-project-sra-2fdf8c78ca1c.herokuapp.com/",
    githublink: "https://github.com/dumplepo/Enhanced_Feedback_Analysis_System",
  },
  {
    id: 4,
    title: "AI Nexus",
